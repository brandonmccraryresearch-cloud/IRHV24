...
In IRH, three generations arise from \textbf{triality automorphism} of \Dfour{}, and mass ratios follow from a single geometric angle $\theta_0 = 2/9$ radians derived from \Dfour{} combinatorics.
...
\textit{Lett. Nuovo Cim.} \textbf{34}, 201 (1982).
\url{https://doi.org/10.1007/BF02748375}
...
\url{https://doi.org/10.1103/PhysRevD.10.275}

\bibitem{Regge1961}
T. Regge,
``General relativity without coordinates,''
\textit{Nuovo Cim.} \textbf{19}, 558 (1961).
...
\bibitem{FermiLAT2013}
Fermi-LAT Collaboration (M. Ackermann \textit{et al.}),
``The Imprint of the Extragalactic Background Light in the Gamma-Ray Spectra of Blazars,''
\textit{Science} \textbf{338}, 1190 (2012).
\url{https://doi.org/10.1126/science.1227160}
