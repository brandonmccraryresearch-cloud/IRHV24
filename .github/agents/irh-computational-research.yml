...
description: |
  ...
  - Scientific Python computing (NumPy, SciPy, SymPy, mpmath)
  - Jupyter notebook development for theoretical physics validation
  - IRH theoretical framework and mathematical derivations
  - Computational validation protocols and precision arithmetic
  - Integration of symbolic and numerical computation methods

# Agent capabilities and domain expertise
expertise:
  primary_domains:
    - github_actions
    - jupyter_notebooks
  ...
  specialized_knowledge:
    - irh_theory_framework
    - fine_structure_constant_derivation
    - cymatic_resonance_networks
    - hopf_fibration_geometry
    - quantum_field_theory_computations
    - cosmological_constant_calculations
...
# Tools and resources the agent can use
tools:
  - bash
  - view
  - create
...
examples:
  - task: "Run the IRH workflow for section 2 (harmony functional)"
    approach: |
  ...
  - task: "Create a new notebook for cosmological constant derivation"
    approach: |
  ...
  - task: "Debug a failing workflow run"
    approach: |
  ...
  - task: "Optimize computation performance"
    approach: |
